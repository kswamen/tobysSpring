package com.example.tobysspring.tobySrc.chapter5.c.test;

import com.example.tobysspring.tobySrc.chapter1.c.DUserDao;
import com.example.tobysspring.tobySrc.chapter5.c.DaoFactory;
...
import com.example.tobysspring.tobySrc.chapter5.c.service.UserService;
...
public class UserServiceTest {
    ...
    public void upgradeAllOrNothing() {
        UserService testUserService = new TestUserService(users.get(3).getId(), this.userDao);
        userDao.deleteAll();
        for (User user : users) {
            userDao.add(user);
        }
